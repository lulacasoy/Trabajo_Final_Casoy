...
#3_ Ya que conocemos la cantidad de habitantes por vivienda que declara cada postulante y la cantidad de ambientes de sus viviendas, podemos conocer también la situación de hacinamiento existente o no en cada caso y cuantificarla. ¿Cómo es este índice de nivel de hacinamiento si lo miramos por provincia?
...
```
# Es clara la relación entre el nivel de hacinamiento en la vivienda y la elección del tipo de obra. El 30% de los hogares que eligieron Ampliar estaban hacinados, mientras que solo el 18% de los que decidieron reformar lo estaba.
